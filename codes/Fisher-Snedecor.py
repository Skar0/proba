...
while(i <= 10):
    ...
    if(sigmas[0] > sigmas[1]):
        print( str( ( (100/99)*sigmas[0] )/( (100/99)*sigmas[1] ) )+" & 1.48 & "),
    else:
        print( str( ( (100/99)*sigmas[1] )/( (100/99)*sigmas[0] ) )+" & 1.48 & "),
    if(sigmas[1] > sigmas[2]):
        print( str( ( (100/99)*sigmas[1] )/( (100/99)*sigmas[2] ) )+" & 1.48 & "),
    else:
        print( str( ( (100/99)*sigmas[2] )/( (100/99)*sigmas[1] ) )+" & 1.48 & "),
    if(sigmas[0] > sigmas[2]):
        print( str( ( (100/99)*sigmas[0] )/( (100/99)*sigmas[2] ) )+" & 1.48 & "),
    else:
        print( str( ( (100/99)*sigmas[2] )/( (100/99)*sigmas[0] ) )+" & 1.48 & "),
    print("\\"+"\\"+"\n")
